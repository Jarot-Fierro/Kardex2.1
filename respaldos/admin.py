...
class RespaldoPacienteAdmin(admin.ModelAdmin):
    list_display = ('rut', 'nombre', 'apellido_paterno', 'apellido_materno','sexo', 'comuna', 'fallecido', 'usuario_eliminacion')
...
class RespaldoFichaAdmin(admin.ModelAdmin):
    list_display = ('numero_ficha_sistema', 'rut', 'paciente', 'establecimiento', 'created_at','usuario_eliminacion')
...
class RespaldoMovimientoAdmin(admin.ModelAdmin):
    list_display = ( 'rut', 'numero_ficha','establecimiento', 'estado', 'fecha_salida', 'fecha_entrada', 'profesional','usuario_eliminacion')
