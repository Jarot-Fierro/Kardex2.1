...
from personas.apis.pacientes import buscar_pacientes_api, paciente_search_api
...
urlpatterns = [
    ...
    # ACCIONES CLÍNICAS
    path("api/pacientes/buscar-nombres/", paciente_search_api, name="paciente_search_api"),
